//
//  XBUnregisterDevicePushWebRequest.m
//  Xblaze-iPhone
//
...
@implementation XBUnregisterDevicePushWebRequest

- (id)initWithBodyString:(NSString *)bodyString
{
	if ((self = [super initWithBodyString:bodyString]))
	{
		_urlRequest = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", serverRoot, unregisterDeviceResource]]];
